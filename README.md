...
设置后给管理员仅添加新增的功能，就能看到管理员无法编辑和删除。如果页面不给任何权限，左侧菜单栏就不会显示页面。
...
<template>
  <el-row>
    <el-col>
      <el-card>
        <div ref="lineChart" style="height:380px; width: 1200px; margin: 0 auto; "></div>
      </el-card>
      <div class="graph">
        <el-card style="height: 360px;">
          <div ref="Histogram" style="height: 380px; width: 600px; margin: 0 auto;"></div>
        </el-card>
        <el-card style="height: 360px;">
          <div ref="PieChart" style="height: 380px; width: 600px; margin: 0 auto;"></div>
        </el-card>
      </div>
    </el-col>
  </el-row>
...
**这样，基于Gin的后台管理系统就完成了。如果要运行到服务器上，前端需要使用`npm run build`，后端使用`go build`就能打包到服务器上解压来部署。**
